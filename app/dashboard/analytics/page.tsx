...
import AnalyticsDashboardWrapper from '../../../components/analytics/AnalyticsDashboard'
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>
            {isRTL ? 'تحليلات متقدمة وتقارير الأداء' : 'Advanced analytics and performance reports'}
          </p>
        </div>

        {businessId ? <AnalyticsDashboardWrapper businessId={businessId} /> : (
