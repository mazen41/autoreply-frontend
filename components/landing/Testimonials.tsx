  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse, color-mix(in srgb, var(--accent) 4%, transparent) 0%, transparent 70%)', filter: 'blur(40px)' }}
      />
              ...
              <div key={i} className="min-w-full px-4 sm:px-16 md:px-32">
                <div
                  ...
                  style={{
                    ...
                    boxShadow: i === active ? '0 0 40px color-mix(in srgb, var(--accent) 6%, transparent)' : 'none',
                  }}
                >
                  ...
                  <p
                    ...
                    style={{ color: 'var(--text-secondary)', maxWidth: 600, margin: '0 auto 2rem' }}
                  >
                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <div className={isRTL ? 'text-right' : 'text-left'}>
                      ...
                      <p className="text-xs" style={{ color: 'var(--text-tertiary)' }}>{item.business}</p>
                    </div>
                  </div>
                </div>
              </div>
