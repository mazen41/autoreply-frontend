...
const IC = {
  ...
  Star: ({ c = 'rgba(255,255,255,0.64)', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
    </svg>
  ),
  Target: ({ c = '#C7DAF8', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2" fill={c} stroke="none"/>
    </svg>
  ),
  MessageSquare: ({ c = 'rgba(255,255,255,0.64)', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>
    </svg>
  ),
  Users: ({ c = 'rgba(255,255,255,0.64)', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/>
      <path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/>
    </svg>
  ),
  PenTool: ({ c = 'rgba(255,255,255,0.64)', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/>
      <path d="M2 2l7.586 7.586"/><circle cx="11" cy="11" r="2"/>
    </svg>
  ),
  DollarSign: ({ c = 'rgba(255,255,255,0.64)', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 100 7h5a3.5 3.5 0 010 7H6"/>
    </svg>
  ),
  Inbox: ({ c = 'rgba(255,255,255,0.64)', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="22 12 16 12 14 15 10 15 8 12 2 12"/>
      <path d="M5.45 5.11L2 12v6a2 2 0 002 2h16a2 2 0 002-2v-6l-3.45-6.89A2 2 0 0016.76 4H7.24a2 2 0 00-1.79 1.11z"/>
    </svg>
  ),
  Moon: ({ c = 'rgba(255,255,255,0.64)', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/>
    </svg>
  ),
  TrendingUp: ({ c = '#C7DAF8', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/>
    </svg>
  ),
  CheckCircle: ({ c = '#C7DAF8', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/>
    </svg>
  ),
  Clock: ({ c = 'rgba(255,255,255,0.64)', s = 20 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>
    </svg>
  ),
  Shield: ({ c = '#C7DAF8', s = 14 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
    </svg>
  ),
  Sparkle: ({ c = '#C7DAF8', s = 14 }) => (
    <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
// ─── DATA ─────────────────────────────────────────────────────────────────────
const CHANNELS = [
  { id: 'wa',  label: 'WhatsApp',  Icon: IC.WhatsApp,  color: '#C7DAF8', angle: -130, dist: 155 },
  { id: 'ig',  label: 'Instagram', Icon: IC.Instagram, color: '#C7DAF8', angle: -60,  dist: 150 },
  { id: 'em',  label: 'Gmail',     Icon: IC.Mail,      color: '#C7DAF8', angle:  60,  dist: 150 },
  { id: 'web', label: 'Website',   Icon: IC.Globe,     color: '#C7DAF8', angle:  130, dist: 155 },
  { id: 'fb',  label: 'Facebook',  Icon: IC.Facebook,  color: '#C7DAF8', angle:  180, dist: 148 },
]
...
const MSGS = [
  { from: 'Ahmed K.', Icon: IC.WhatsApp, color: '#C7DAF8', ar: 'هل التوصيل متاح؟',      en: 'Is delivery available?',  status: 'Replied',    sc: '#C7DAF8' },
  { from: 'سارة م.',  Icon: IC.Instagram,color: '#C7DAF8', ar: 'ما هي ساعات العمل؟',    en: 'What are your hours?',    status: 'Processing', sc: '#C7DAF8' },
  { from: 'Nora H.',  Icon: IC.Mail,     color: '#C7DAF8', ar: 'أريد حجز طاولة لـ 4',   en: 'Table for 4 please',      status: 'Replied',    sc: '#C7DAF8' },
  { from: 'خالد ع.',  Icon: IC.Globe,    color: '#C7DAF8', ar: 'كم سعر الباقة؟',         en: 'Business plan price?',    status: 'Lead ⚡',   sc: '#C7DAF8' },
  { from: 'Omar F.',  Icon: IC.WhatsApp, color: '#C7DAF8', ar: 'شكراً على الرد السريع!', en: 'Thanks for quick reply!', status: 'Closed',    sc: 'rgba(255,255,255,0.35)' },
]
    ...
    <div className="relative flex items-center justify-center select-none" style={{ width: s, height: s }}>
      {[0,1,2].map(i => (
        <div key={i} className="absolute rounded-full" style={{
          ...
          border: '1px solid rgba(199,218,248,0.22)',
      ...
      <div className="absolute rounded-full core-rotate" style={{
        ...
        borderRight: '1px solid rgba(199,218,248,0.12)',
      }} />
      <div className="absolute rounded-full core-rotate-rev" style={{
        ...
        borderLeft: '1px solid rgba(199,218,248,0.12)',
      }} />
      <div className="relative core-glow flex items-center justify-center" style={{
        width: s * 0.5, height: s * 0.5, borderRadius: '50%',
        background: 'radial-gradient(circle at 38% 33%, rgba(199,218,248,0.18) 0%, rgba(199,218,248,0.03) 55%, transparent 80%)',
        border: '1.5px solid rgba(199,218,248,0.45)',
      }}>
        <svg width={s * 0.18} height={s * 0.18} viewBox="0 0 24 24" fill="none">
          <path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17l-6.2 4.3 2.4-7.4L2 9.4h7.6L12 2z"
            fill="#C7DAF8" style={{ filter: 'drop-shadow(0 0 8px rgba(199,218,248,0.9))' }}/>
        </svg>
      </div>
  ...
  return (
    <motion.div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-6"
      ...
      <motion.div custom={2} initial="hidden" animate="visible" variants={variants}
        ...
        {[
          { v: '247',   l: isRTL ? 'محادثة نشطة' : 'Active Convos', c: '#C7DAF8' },
          { v: '3,842', l: isRTL ? 'رد اليوم'    : 'Replies Today', c: '#C7DAF8' },
          { v: '128',   l: isRTL ? 'عميل محتمل'  : 'Leads Today',   c: '#C7DAF8' },
          { v: '8s',    l: isRTL ? 'وقت الرد'    : 'Avg Response',  c: '#C7DAF8' },
        ].map((m, i) => (
  ...
  return (
    <motion.div className="absolute inset-0 flex flex-col items-center justify-center z-10"
      ...
      <div className="absolute top-24 text-center">
        ...
        <h2 className="font-black" style={{ fontSize: 'clamp(1.6rem,3vw,2.8rem)', color: '#FFFFFF', letterSpacing: '-0.04em' }}>
    ...
    <motion.div className="absolute inset-0 flex items-center justify-center z-10 px-6"
      ...
      <div className="w-full max-w-4xl flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="flex-1 max-w-sm w-full">
          <div className="text-[10px] font-bold tracking-widest mb-3" style={{ color: '#C7DAF8' }}>
            {isRTL ? 'رسائل واردة — مباشر' : 'INCOMING — LIVE'}
          </div>
          <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(199,218,248,0.95)', border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div className="p-2 space-y-1.5">
              {MSGS.map((msg, i) => (
                <div key={msg.from} className="flex items-center gap-2.5 p-2.5 rounded-xl transition-all duration-300"
                  style={{ background: activeMsg === i ? 'rgba(199,218,248,0.05)' : 'rgba(255,255,255,0.02)', borderLeft: activeMsg === i ? '2px solid rgba(199,218,248,0.4)' : '2px solid transparent' }}>
                  <div className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0"
                    style={{ background: `${msg.color}12`, border: `1px solid ${msg.color}20` }}>
                    <msg.Icon c={msg.color} s={14} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="text-[11px] font-bold" style={{ color: '#FFFFFF' }}>{msg.from}</div>
                  ...
                  {activeMsg === i ? (
                    <div className="flex gap-0.5 flex-shrink-0">
                      {[0,1,2].map(j => <div key={j} style={{ width: 3, height: 3, borderRadius: '50%', background: '#C7DAF8', animation: `typingDot 1.2s ease ${j*0.2}s infinite` }} />)}
                    </div>
                  ) : (
        ...
        <div className="flex-1 max-w-xs w-full">
          ...
          <div className="rounded-2xl p-4" style={{ background: 'rgba(199,218,248,0.95)', border: '1px solid rgba(199,218,248,0.1)' }}>
            {[
              { l: isRTL ? 'تحليل النص'   : 'Text Analysis',    p: 94, c: '#C7DAF8' },
              { l: isRTL ? 'توليد الرد'   : 'Response Gen',     p: 88, c: '#C7DAF8' },
              { l: isRTL ? 'إدارة السياق' : 'Context Handling', p: 97, c: '#C7DAF8' },
              { l: isRTL ? 'اكتشاف النية' : 'Intent Detection', p: 91, c: '#C7DAF8' },
            ].map((b, i) => (
            ...
            <div className="pt-3 mt-3 flex items-center justify-between" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
              ...
              <span className="text-sm font-black" style={{ color: '#C7DAF8' }}>8s</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div key={cap.id} className="absolute flex flex-col items-center gap-1.5"
            ...
            {isHot && (
              <div className="absolute rounded-full" style={{
                width: 52, height: 52, border: '1.5px solid rgba(199,218,248,0.55)',
            ...
            <div className="w-11 h-11 rounded-xl flex items-center justify-center"
              style={{
                background: isHot ? 'rgba(199,218,248,0.12)' : 'rgba(199,218,248,0.95)',
                border: `1.5px solid ${isHot ? 'rgba(199,218,248,0.5)' : 'rgba(199,218,248,0.12)'}`,
                boxShadow: isHot ? '0 0 24px rgba(199,218,248,0.22)' : 'none',
                backdropFilter: 'blur(8px)',
                transition: 'all 0.3s ease',
              }}>
              <cap.Icon c={isHot ? '#C7DAF8' : 'rgba(255,255,255,0.45)'} s={18} />
            </div>
            <div className="text-[10px] font-bold text-center whitespace-nowrap px-2 py-0.5 rounded-lg"
              style={{
                background: 'rgba(199,218,248,0.95)', border: '1px solid rgba(255,255,255,0.05)',
                color: isHot ? '#C7DAF8' : 'rgba(255,255,255,0.45)',
...
function State4({ op, isRTL }: { op: MotionValue<number>; isRTL: boolean }) {
  ...
  const flow = [
    { Icon: IC.MessageSquare, ar: 'رسالة',  en: 'Message', c: '#C7DAF8' },
    { Icon: IC.Sparkle,       ar: 'ذكاء',   en: 'AI',      c: '#C7DAF8' },
    { Icon: IC.Zap,           ar: 'إجراء',  en: 'Action',  c: '#C7DAF8' },
    { Icon: IC.Target,        ar: 'نتيجة',  en: 'Result',  c: '#C7DAF8' },
  ]
  const cards = [
  ...
  return (
    <motion.div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-6"
      ...
      <div className="text-center mb-10">
        <div className="inline-flex items-center gap-2 mb-3 px-4 py-2 rounded-full glass"
          style={{ border: '1px solid rgba(199,218,248,0.16)' }}>
          <IC.Zap c="#C7DAF8" s={12} />
          <span className="text-xs font-bold tracking-[0.12em]" style={{ color: '#C7DAF8' }}>
          ...
          <React.Fragment key={i}>
            <div className="flex flex-col items-center gap-2 transition-all duration-300"
              ...
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center transition-all duration-300"
                style={{
                  background: step === i ? `${s.c}14` : 'rgba(199,218,248,0.9)',
      ...
      <div className="flex flex-wrap justify-center gap-4">
        {cards.map((c, i) => (
          <div key={i} className="rounded-2xl p-5 w-44 sm:w-52"
            style={{ background: 'rgba(199,218,248,0.92)', border: '1px solid rgba(199,218,248,0.08)' }}>
            <div className="mb-3"><c.Icon c="#C7DAF8" s={22} /></div>
            <div className="text-sm font-bold mb-2" style={{ color: '#FFFFFF' }}>{isRTL ? c.ar : c.en}</div>
            <div className="text-[11px] font-bold" style={{ color: '#C7DAF8' }}>{isRTL ? c.r_ar : c.r_en}</div>
          </div>
        ))}
      </div>
    </motion.div>
  ...
  return (
    <motion.div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-6"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-3xl mb-8">
        {OUTCOMES.map((item, i) => (
          <div key={i} className="card-os rounded-2xl p-5 text-center"
            style={{ background: 'rgba(199,218,248,0.92)', border: '1px solid rgba(255,255,255,0.05)' }}>
            <div className="flex justify-center mb-2"><item.Icon c="#C7DAF8" s={20} /></div>
            <div className="text-[10px] mb-2" style={{ color: 'rgba(199,218,248,0.65)' }}>
              {isRTL ? 'قبل: ' : 'Before: '}{item.before}
            </div>
            <div className="text-3xl font-black" style={{ color: '#C7DAF8', letterSpacing: '-0.04em' }}>
              {vals[i]}
            </div>
            ...
            <div className="flex items-center justify-center gap-1 mt-2">
              <IC.TrendingUp c="#C7DAF8" s={10} />
              <span className="text-[10px] font-bold" style={{ color: '#C7DAF8' }}>{isRTL ? 'تحسن' : 'Improved'}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="rounded-2xl p-5 w-full max-w-xl"
        ...
        {[
          { l: isRTL ? 'رضا العملاء'  : 'Customer Satisfaction', p: 94, c: '#C7DAF8' },
          { l: isRTL ? 'سرعة الرد'    : 'Response Speed',        p: 98, c: '#C7DAF8' },
          { l: isRTL ? 'معدل التحويل' : 'Conversion Rate',       p: 41, c: '#C7DAF8' },
        ].map((b, i) => (
          <div key={i} className="mb-3 last:mb-0">
    ...
    <motion.div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4 pt-20 pb-4 overflow-y-auto"
      ...
      <div className="text-center mb-6">
        <div className="inline-flex items-center gap-2 mb-3 px-4 py-2 rounded-full glass"
          style={{ border: '1px solid rgba(199,218,248,0.2)' }}>
          <IC.Sparkle c="#C7DAF8" s={12} />
          <span className="text-[11px] font-bold tracking-widest" style={{ color: '#C7DAF8' }}>
            {isRTL ? 'نشر بنية الذكاء الاصطناعي' : 'DEPLOY AI INFRASTRUCTURE'}
          </span>
        </div>
        <h2 className="font-black" style={{ fontSize: 'clamp(1.5rem,2.8vw,2.6rem)', color: '#FFFFFF', letterSpacing: '-0.04em' }}>
          {isRTL ? 'اختر مستوى التفعيل.' : 'Choose your activation tier.'}
        </h2>
        <div className="flex items-center justify-center gap-3 mt-3">
          <span className="text-xs font-medium" style={{ color: !annual ? '#FFFFFF' : 'rgba(255,255,255,0.35)' }}>
            {isRTL ? 'شهري' : 'Monthly'}
          </span>
          ...
          <span className="text-xs font-medium flex items-center gap-1.5" style={{ color: annual ? '#FFFFFF' : 'rgba(255,255,255,0.35)' }}>
            {isRTL ? 'سنوي' : 'Annual'}
        ...
        {(displayPlans ?? PLANS).map((plan: any, i: number) => {
          ...
          const inner = (
            <div className="relative rounded-2xl p-4 flex flex-col h-full"
              style={{ background: isPop ? 'rgba(199,218,248,0.99)' : 'rgba(199,218,248,0.92)', border: isPop ? 'none' : '1px solid rgba(255,255,255,0.05)', backdropFilter: 'blur(20px)' }}>
              {isPop && (
              ...
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-sm font-black" style={{ color: isPop ? '#C7DAF8' : '#FFFFFF' }}>{name}</h3>
                <IC.Sparkle c={isPop ? '#C7DAF8' : 'rgba(255,255,255,0.18)'} s={13} />
              </div>
              <div className="flex items-end gap-1 mb-3">
                <span className="text-2xl font-black" style={{ color: isPop ? '#C7DAF8' : '#FFFFFF', letterSpacing: '-0.04em' }}>
              ...
              <Link href={href}
                ...
                style={isPop
                  ...
                  : { border: '1px solid rgba(255,255,255,0.08)', color: '#FFFFFF', background: 'rgba(255,255,255,0.02)' }
                }>
    ...
    <div ref={scrollRef} style={{ height: '700vh' }} className="relative">
      <div className="sticky top-0 h-screen overflow-hidden">
          ...
          {LABELS.map((lbl, i) => (
            <div key={i} className="flex items-center gap-2"
              ...
              <div className="rounded-full flex-shrink-0 transition-all duration-300"
                style={{ width: stateIdx === i ? 20 : 4, height: 4, background: stateIdx === i ? '#C7DAF8' : 'rgba(255,255,255,0.15)' }} />
              {stateIdx === i && (
                <span className="text-[10px] font-bold whitespace-nowrap"
                  style={{ color: '#C7DAF8', letterSpacing: '0.08em' }}>
                  {isRTL ? lbl.ar : lbl.en}
                </span>
              )}
            </div>
        ...
        <motion.div className="absolute bottom-0 left-0 h-[2px] z-50"
          style={{ width: barWidth, background: 'linear-gradient(to right, #C7DAF8, #C7DAF8)', boxShadow: '0 0 8px rgba(199,218,248,0.5)' }} />
      </div>
    </div>
  )
}
