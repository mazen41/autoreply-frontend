...
function AccordionItem({
  ...
  return (
    <div
      ...
      style={{
        border: `1px solid ${isOpen ? 'rgba(199,218,248,0.2)' : 'rgba(255,255,255,0.06)'}`,
        background: isOpen ? 'rgba(199,218,248,0.03)' : '#121317',
      }}
    >
      <button
      ...
      >
        ...
        <div
          ...
          style={{
            background: isOpen ? 'rgba(199,218,248,0.15)' : 'rgba(255,255,255,0.06)',
            transform: isOpen ? 'rotate(45deg)' : 'rotate(0deg)',
            color: isOpen ? '#C7DAF8' : 'rgba(255,255,255,0.4)',
          }}
        >
          +
        </div>
