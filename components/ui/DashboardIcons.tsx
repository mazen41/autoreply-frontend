...
export const NotificationIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    ...
    style={style}
  >
    <path d="M18 8A6 6 0 0 0 6 12c0 7 3 9 3 9H3s3-2 3-9" />
    <path d="M13.73 21a2 2 0 0 1-3.46 0" />
  </svg>
)

export const MailIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="m22 7-8.007 8.007-2.008 2.008" />
  </svg>
)
...
export const WorkflowIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const TagIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    style={style}
  >
    <path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v4.09" />
    <line x1="M12" x1="22" y1="2" y2="22" />
  </svg>
)

export const FileTextIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PlugIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CalendarIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <line x1="16" x2="8" y1="2" y2="2" />
    <line x1="16" x2="16" y1="6" y2="10" />
    <line x1="8" x2="8" y1="6" y2="10" />
    <line x1="16" x2="16" y1="14" y2="18" />
    <line x1="8" x2="8" y1="14" y2="18" />
  </svg>
)

export const AlertIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    style={style}
  >
    <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3.16L6 14.12a2 2 0 0 0 2.12 2.12l4.77-1.06a2 2 0 0 0 2.12-2.12L20.47 3.86a2 2 0 0 0 1.71-3.16L18 12 3.83" />
    <path d="M12 12h.01" />
  </svg>
)

export const RefreshIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SendIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <polygon points="22 2 15 22 15 11" />
  </svg>
)

export const LayersIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    style={style}
  >
    <polygon points="12 2 2 7 12 12 2 22 7 12 2 2 7 12 2 12 17 2 22 12 17 12 2" />
  </svg>
)

export const LinkIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M14 7a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" />
  </svg>
)

export const BarChartIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const TelegramIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const TikTokIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ShopifyIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const WooCommerceIcon = ({ size = 20, className = '', strokeWidth = 1.5, style }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
