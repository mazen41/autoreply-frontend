      ...
      {result && !limitReached && (
        ...
        >
          {result.campaigns?.map((campaign: any, i: number) => (
            <div key={i} className="p-5 rounded-xl" style={{ background: 'rgba(18,19,23,0.9)', border: '1px solid rgba(255,255,255,0.1)' }}>
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-bold" style={{ color: '#C7DAF8' }}>{campaign.name}</h3>
                <span className="text-xs px-2 py-1 rounded" style={{ background: 'rgba(199,218,248,0.1)', color: '#C7DAF8' }}>
                  Idea {i + 1}
                </span>
              </div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="p-3 rounded-lg" style={{ background: 'rgba(199,218,248,0.05)' }}>
                  <div className="flex items-start justify-between gap-2">
                    <span className="font-semibold" style={{ color: '#C7DAF8' }}>نص إنستغرام / Caption:</span>
                    <button
